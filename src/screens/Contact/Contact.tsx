        ...
        <div>
          ...
          <div className="container-contact">
            <div className="container-contact-info">
              ...
              <div className="container-contact-info-2">
                <p>
                  NgáoService ra đời với mong muốn mang lại cho khách hàng sự
                  chuyên nghiệp, uy tín mang nét đẹp hoa mỹ mà chúng tôi đem lại
                  sự trải nghiệm tốt nhất cho thú cưng của mọi nhà với hơn nhiều
                  năm kinh nghiệm trong ngành dịch vụ thú cưng bao gồm: Spa thú
                  cưng, Thú y, Huấn luyện thú cưng, Dịch vụ dắt chó đi dạo, Cung
                  cấp các dòng thú cưng chuyên nghiệp…
                </p>
              </div>
              <div className="container-contact-info-3">
                <FontAwesomeIcon icon={faStore} />{" "}
                <span>397-5 Hapjeong-dong, Mapo-gu, Seoul, Hàn Quốc</span>
                <br />
                <FontAwesomeIcon icon={faPhone} /> <span>+82234421104</span>{" "}
                <br />
                <FontAwesomeIcon icon={faEnvelope} />{" "}
                <span>ngaoservice@gmail.com</span>
              </div>
