...
import { Avatar, List, Select, Space, Form, Button } from 'antd';
...
const FilterEmployee = () => {
  ...
  return (
    <div>
      ...
      <Select onSelect={selectedService} options={[
        {
          value: 'trainer',
    ...
    dataSource={employeeData.filter((item) => service!=='' ? item.type===service : item)}
