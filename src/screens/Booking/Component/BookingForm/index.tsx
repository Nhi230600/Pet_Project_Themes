...
const BookingForm: React.FC<BookingFormProps> = ({
  ...
  return (
    <form action="#" className="form-content">
      ...
      <p>
        {" "}
        Các trường đánh dấu <strong className="important">*</strong> là bắt
        buộc
      </p>
      <h3>
        {" "}
      ...
      <p>
        {" "}
        Vui lòng chọn 1 dịch vụ bạn đang cần để NgáoService có thể chuẩn bị,
        và phục vụ các bé một cách chu đáo nhất nhé!
      </p>
