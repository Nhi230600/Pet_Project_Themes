  ...
  return (
    <div>
      ...
      <div className='container-booktrainer'>
        <div className='container-booktrainer-heading' style={{fontSize:FONTSIZE.logoLarge}}>
          <span>
            Book Online 24/7
          </span>
        </div>
        <div className='container-booktrainer-content'>
          <form className='container-booktrainer-content-form'>
            <h1 className='container-booktrainer-content-form-heading'>Đặt lịch Huấn luyện</h1>
            <p> Đặt lịch nhanh</p>
            <p> Các trường đánh dấu <strong className='important'>*</strong> là bắt buộc</p>
            <h3> YÊU CẦU TRAINER: <strong className='important'>*</strong></h3>
            <p> Vui lòng chọn huấn luyện viên bạn yêu thích để NgáoService cử đến huấn luyện cho Pet của bạn nhé !</p>
