        ...
        {trainerdata.map((data) => (
          <div className="trainerlist-container-content-detail">
            ...
            <div className="trainerlist-container-content-detail-name">
              <h1 className='trainerlist-container-content-detail-name-1'>{data.name}</h1>
              <p className='trainerlist-container-content-detail-name-2'>{data.position}</p>
              <p className='trainerlist-container-content-detail-name-2'>{data.exp}</p>
